    ...
    showStoreLocator() {
        const result = this.showTemplate("plantilla-ubicacion", "container-principal")
        return result
    }
    ...
    initMap(defaultLat = 4.60971, defaultLng = -74.081749, defaultZoom = 12) {
        ...
        console.error("Leaflet no está disponible. Asegúrate de incluir la biblioteca en tu HTML.")
        return null
        }
