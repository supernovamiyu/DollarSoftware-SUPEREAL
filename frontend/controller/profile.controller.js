    class ProfileController {
        ...
        if (sectionId) {
            ...
            setTimeout(() => {
            document.dispatchEvent(new CustomEvent("profileSectionLoaded", { 
                detail: sectionId 
            }));
            }, 300);
        }
        ...
        async viewOrderDetails(orderId) {
            try {
                const order = this.userOrders.find(o => o.id_pedido === orderId || o.id === orderId || o.id_peddo === orderId) || 
        ...
        try {
            ...
            this.view.showMessage("Error al guardar los cambios", "error");
        }
        }
